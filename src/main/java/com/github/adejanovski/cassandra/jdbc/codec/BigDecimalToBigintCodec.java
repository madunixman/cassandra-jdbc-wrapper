...
public class BigDecimalToBigintCodec extends TypeCodec<BigDecimal> {
  ...
  @Override
  public ByteBuffer serialize(BigDecimal paramT, ProtocolVersion paramProtocolVersion) {
    if (paramT == null) {
      return null;
    }
  ...
  @Override
  public BigDecimal deserialize(ByteBuffer paramByteBuffer, ProtocolVersion paramProtocolVersion) {
  ...
  @Override
  public BigDecimal parse(String paramString) {
    return BigDecimal.valueOf(Long.valueOf(paramString));
  }

  @Override
  public String format(BigDecimal paramT) {
